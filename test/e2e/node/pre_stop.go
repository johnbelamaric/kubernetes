...
var _ = SIGDescribe("PreStop", func() {
	...
	*/
	framework.ConformanceIt2("pods-prestop-called", "should call prestop when killing a pod ", func() {
		testPreStop(f.ClientSet, f.Namespace.Name)
	})

	framework.ConformanceIt2("pods-graceful-with-prestop", "graceful pod terminated should wait until preStop hook completes the process", func() {
